...
export default function ProductCard({ product, variants, regionBadge, highlight }: Props) {
  ...
  return (
    <Link
      ...
      className={`card-premium group relative flex flex-col overflow-hidden rounded-lg border bg-surface hover:shadow-xl hover:shadow-accent-chrome/10 hover:glow-chrome-sm ${
